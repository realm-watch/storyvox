...
<section class="recent">
  ...
  <p>
    <strong>v0.5.50</strong> — Nav restructure: Settings becomes a primary nav destination,
    ...
    <a href="https://github.com/techempower-org/storyvox/releases/tag/v0.5.50">Full release notes →</a>
  </p>
  <p>
