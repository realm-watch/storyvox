...
<section class="recent">
  ...
  <p>
    <strong>v0.5.35</strong> — Library Nocturne UX milestone. Full brass-on-warm-dark
    ...
    <a href="https://github.com/techempower-org/storyvox/releases/tag/v0.5.35">Full release notes →</a>
  </p>
  <p>
