...
<section class="recent">
  ...
  <p>
    <strong>v0.5.41</strong> — Nav restructure: Settings becomes a primary nav destination,
    ...
    <a href="https://github.com/techempower-org/storyvox/releases/tag/v0.5.41">Full release notes →</a>
  </p>
  <p>
