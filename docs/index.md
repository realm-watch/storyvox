...
<section class="recent">
  ...
  <p>
    <strong>v0.5.01</strong> — Library Nocturne UX milestone. Full brass-on-warm-dark
    ...
    <a href="https://github.com/jphein/storyvox/releases/tag/v0.5.01">Full release notes →</a>
  </p>
  <p>
